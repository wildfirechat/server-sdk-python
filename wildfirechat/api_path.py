"""
API路径定义
对应Java SDK中的 cn.wildfirechat.common.APIPath
"""
...
class APIPath:
    ...
    # Domain
    Create_Domain = "/admin/domain/create"
    Get_Domain = "/admin/domain/get"
    Destroy_Domain = "/admin/domain/destroy"
    List_Domain = "/admin/domain/list"
    Ping_Domain = "/admin/domain/ping"
